...
<?php get_header(); ?>
			...
			<div id="content" class="clearfix row">
				...
				<div id="main" class="span8 clearfix" role="main">
					<ol class="breadcrumbs clearfix"><?php if(function_exists('bcn_display')): bcn_display(); endif; ?></ol>
					...
					<article id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?> role="article" itemscope itemtype="http://schema.org/Article">
						...
						<header>
							...
							<div class="page-header clearfix">
								<?php the_post_thumbnail(array(96, 96)); ?>
								<h1 class="single-title" itemprop="headline" itemprop="name"><?php the_title(); ?></h1>
							</div>

<?php include TEMPLATEPATH .  "/../individual_head_ad.php"; ?>

							<p class="meta"><?php _e("Posted", "bonestheme"); ?> <time itemprop="datePublished" content="<?php echo the_time('c'); ?>" datetime="<?php echo the_time('Y-m-d H:i'); ?>" pubdate class="date"><?php the_date('Y-m-d H:i'); ?></time> <?php _e("by", "bonestheme"); ?> <?php the_author_posts_link(); ?> <span class="amp">&</span> <?php _e("filed under", "bonestheme"); ?> <?php the_category(', '); ?>.</p>
